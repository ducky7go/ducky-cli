# Spec: CLI NuGet Validation

**Capability ID:** `cli-nuget-validation`
...
- `cli-nuget-pack`: Validation is run before packaging
- `cli-nuget-push`: Validation is run before publishing (when using --pack)
