...
- The validator checks:
  1. Steam App ID is valid (numeric, positive)
  2. Directory exists
  3. `info.ini` exists and is valid
  4. `preview.png` exists
  5. Mod directory structure is valid
- App ID cannot be added to info.ini, only set via environment variable
