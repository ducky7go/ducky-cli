#!/bin/bash
# Script to push Newbe.HurtToWarm mod to Steam Workshop using local ducky CLI
...
if [ "$USE_NPM_DEV" = true ]; then
    ...
    echo ""
    echo "Pushing mod to Steam Workshop..."
    ...
    # Use local ducky to push to Steam Workshop
